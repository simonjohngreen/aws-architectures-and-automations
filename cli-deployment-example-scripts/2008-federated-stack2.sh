aws cloudformation create-stack \
  ...
  --disable-rollback \
  --template-url https://s3-eu-central-1.amazonaws.com/contrail-one-click-deployers/2008-Stack2.json \
  --parameters \
...
ParameterKey=InstallerCS3Location,ParameterValue="https://s3-eu-central-1.amazonaws.com/contrail-one-click-deployers/2008.yaml"
